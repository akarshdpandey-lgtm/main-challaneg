  ...
  return (
    <Router>
      <div className="relative min-h-screen bg-slate-950 flex flex-col font-sans antialiased text-gray-100 overflow-x-hidden selection:bg-brand-gold selection:text-gray-950">
        ...
        <div className="fixed bottom-6 right-6 z-[9999] flex items-center space-x-1.5 px-3.5 py-2 rounded-full bg-slate-950/90 border border-white/10 text-[10px] font-sans font-semibold text-white shadow-xl backdrop-blur-md pointer-events-auto">
